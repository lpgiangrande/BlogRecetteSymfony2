...
/* base.html.twig */
class __TwigTemplate_d53bf881e848ba7a709d2e45c9df59064b5ba5a001a4026f0821d274237f01df extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        ...
        echo "\">Home <span class=\"sr-only\">(current)</span></a>
                    ...
                    ";
        // line 22
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN", twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "user", [], "any", false, false, false, 22))) {
            // line 23
            echo "                        <li class=\"nav-item ";
            if (((isset($context["menu"]) || array_key_exists("menu", $context)) && (0 === twig_compare((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 23, $this->source); })()), "admin")))) {
                echo " active ";
            }
            echo "\">
                            <a class=\"nav-link\" href=\"";
...
";
    ...
    {
        return array (  198 => 39,  180 => 38,  162 => 7,  143 => 5,  131 => 40,  128 => 39,  126 => 38,  120 => 34,  114 => 32,  108 => 30,  106 => 29,  102 => 27,  96 => 24,  89 => 23,  87 => 22,  81 => 19,  75 => 18,  65 => 11,  60 => 8,  58 => 7,  53 => 5,  47 => 1,);
    }
...
<html>
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">
            <a class=\"navbar-brand\" href=\"{{ path('home') }}\">Barmiton exo</a>
            <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
                <span class=\"navbar-toggler-icon\"></span>
            </button>

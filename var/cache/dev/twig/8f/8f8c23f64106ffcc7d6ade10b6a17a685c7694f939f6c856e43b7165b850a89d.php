...
class __TwigTemplate_44582a32e514a04bc9c9d0468f57691b22acae5ee1fc25804797f44a74ecf216 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["recette"]) {
            ...
            echo "</td>
                    <td>
                        <a href=\"";
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["recette"], "id", [], "any", false, false, false, 33)]), "html", null, true);
            echo "\" class=\"btn btn-secondary btn-sm\">Editer</a>
...
";
    ...
    {
        return array (  155 => 38,  144 => 33,  139 => 31,  135 => 30,  132 => 29,  128 => 28,  114 => 17,  107 => 12,  98 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container mt-5\"> <!-- Ajoute une alert success quand recette ajoutée -->
        ...
        <a href=\"{{ path('admin_create') }}\"class=\"btn btn-success btn-sm mt-3 mb-3\">Ajouter</a>
        ...
        <table class=\"table table-striped\">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ recette.titre}}</td>
                    <td>
                        <a href=\"{{path('admin_edit', {id: recette.id} ) }}\" class=\"btn btn-secondary btn-sm\">Editer</a>
                        <button class=\"btn btn-danger btn-sm\">Supprimer</button>
                    </td>
                </tr>
                {% endfor %}
...
{% endblock %}", "admin/index.html.twig", "/Users/lpgia/blogrecette/templates/admin/index.html.twig");
    }
}

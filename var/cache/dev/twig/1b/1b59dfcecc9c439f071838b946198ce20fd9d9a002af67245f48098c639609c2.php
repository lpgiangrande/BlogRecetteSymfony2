...
class __TwigTemplate_7f6b81bcdd8e3fd479dbeaafdbedd74c722e63db3a81f7a98adc2cf8bb1dce75 extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Accueil - exo Symfony, blogs de recettes</h1>

    ";
        // line 9
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["recettes"]) || array_key_exists("recettes", $context) ? $context["recettes"] : (function () { throw new RuntimeError('Variable "recettes" does not exist.', 9, $this->source); })()));
...
";
    ...
    {
        return array (  121 => 20,  110 => 15,  106 => 14,  102 => 13,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %} Home page {% endblock %} {# Modifie contenu onglet du site #}

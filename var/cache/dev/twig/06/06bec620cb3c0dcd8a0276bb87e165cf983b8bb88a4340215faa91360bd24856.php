...
class __TwigTemplate_e3ad8130510a493a019ac6daf959afd3e3cdbc8970355ee756d0124dfbec3467 extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <p>Monsieur ou Madame ";
        ...
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 11, $this->source); })()), "prenom", [], "any", false, false, false, 11), "html", null, true);
        echo " a essayé de vous contacter.
    
    Vous pouvez la recontacter via son email : ";
        // line 13
    ...
    <p>
        ";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 18, $this->source); })()), "message", [], "any", false, false, false, 18), "html", null, true);
        echo " 
    </p>
    ...
    {
        return array (  70 => 18,  62 => 13,  55 => 11,  43 => 1,);
    }
...
<body>
    ...
    <p>Monsieur ou Madame {{contact.nom}} {{contact.prenom}} a essayé de vous contacter.
    
    Vous pouvez la recontacter via son email : {{contact.email}} 
...
</html>", "email/contact.html.twig", "/Users/lpgia/blogrecette/templates/email/contact.html.twig");
    }
}
